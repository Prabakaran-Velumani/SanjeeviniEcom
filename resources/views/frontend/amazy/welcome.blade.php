...
<div class="container">
    <div class="row">
      <div class="custom-col col-sm-6 col-md-4 col-lg-3">
            <div class="image-box">
			
			        <img src="public/frontend/amazy/img/wnecklace.webp" 
     srcset="public/frontend/amazy/img/wnecklace.webp 320w,
           public/frontend/amazy/img/wnecklace.webp 640w,
             public/frontend/amazy/img/wnecklace.webp 1024w"
     sizes="(max-width: 600px) 320px, 
            (max-width: 1200px) 640px, 
            1024px"
     alt="wnecklace" width="387" height="306" loading="lazy">
  ...
  <button class="shop-buttons">Shop Now</button>
       ...
       <div class="custom-col col-sm-6 col-md-4 col-lg-3">
            <div class="image-box">
                <img src="public/frontend/amazy/img/imgg1.webp" 
     srcset="public/frontend/amazy/img/imgg1.webp 320w,
             public/frontend/amazy/img/imgg1.webp 640w,
             public/frontend/amazy/img/imgg1.webp 1024w"
     sizes="(max-width: 600px) 320px, 
            (max-width: 1200px) 640px, 
            1024px"
     alt="Gl" width="387" height="306" loading="lazy">
                <div class="content">
                    <div class="discount">
                    <div class="discount-row">
 ...
 <div class="custom-col col-sm-6 col-md-4 col-lg-3">
            <div class="image-box">
			 ...
			 <img src="public/frontend/amazy/img/imgg2.webp" 
     srcset="public/frontend/amazy/img/imgg2.webp 320w,
           public/frontend/amazy/img/imgg2.webp 640w,
           public/frontend/amazy/img/imgg2.webp 1024w"
     sizes="(max-width: 600px) 320px, 
            (max-width: 1200px) 640px, 
            1024px"
     alt="Channapatna" width="387" height="306"loading="lazy">
...
<div class="custom-col col-sm-6 col-md-4 col-lg-3">
            <div class="image-box">
				 ...
				 <img src="public/frontend/amazy/img/imgg3.webp" 
     srcset="public/frontend/amazy/img/imgg3.webp 320w,
           public/frontend/amazy/img/imgg3.webp 640w,
          public/frontend/amazy/img/imgg3.webp 1024w"
     sizes="(max-width: 600px) 320px, 
            (max-width: 1200px) 640px, 
            1024px"
     alt="homemade" width="387" height="306"loading="lazy">
  ...
  <button class="shop-buttons">Shop Now</button>
    ...
    <div class="custom-col col-sm-6 col-md-4 col-lg-3">
			...
			<img src="public/frontend/amazy/img/imgg4.webp" 
     srcset="public/frontend/amazy/img/imgg4.webp 320w,
           public/frontend/amazy/img/imgg4.webp 640w,
         public/frontend/amazy/img/imgg4.webp 1024w"
     sizes="(max-width: 600px) 320px, 
            (max-width: 1200px) 640px, 
            1024px"
     alt="banana-fiber" width="387" height="306"loading="lazy">
  ...
  <button class="shop-buttons">Shop Now</button>
    ...
    <div class="custom-col col-sm-6 col-md-4 col-lg-3">
            <div class="image-box">
				...
				<img src="public/frontend/amazy/img/imgg5.webp" 
     srcset="public/frontend/amazy/img/imgg5.webp 320w,
           public/frontend/amazy/img/imgg5.webp 640w,
        public/frontend/amazy/img/imgg5.webp 1024w"
     sizes="(max-width: 600px) 320px, 
            (max-width: 1200px) 640px, 
            1024px"
     alt="Gift" width="387" height="306"loading="lazy">
  ...
  <button class="shop-buttons">Shop Now</button>
       ...
       <div class="custom-col col-sm-6 col-md-4 col-lg-3">
            <div class="image-box">
						<img src="public/frontend/amazy/img/imgg6.webp" 
     srcset="public/frontend/amazy/img/imgg6.webp 320w,
           public/frontend/amazy/img/imgg6.webp 640w,
        public/frontend/amazy/img/imgg6.webp 1024w"
     sizes="(max-width: 600px) 320px, 
            (max-width: 1200px) 640px, 
            1024px"
     alt="Tea" width="387" height="306"loading="lazy">
  ...
  <button class="shop-buttons">Shop Now</button>
      ...
      <div class="custom-col col-sm-6 col-md-4 col-lg-3">
            <div class="image-box">
						...
						<img src="public/frontend/amazy/img/imgg7.webp" 
     srcset="public/frontend/amazy/img/imgg7.webp 320w,
         public/frontend/amazy/img/imgg7.webp 640w,
        public/frontend/amazy/img/imgg7.webp 1024w"
     sizes="(max-width: 600px) 320px, 
            (max-width: 1200px) 640px, 
            1024px"
     alt="Buddha" width="387" height="306"loading="lazy">
...
@endphp
<div class="amaz_section section_spacing3 dip">
    <div class="container">
        <div class="row">
            <div class="col-12">
...
<div class="container">
  <div class="row align-items-center">
      ...
      <div id="imageCarousel" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="public/uploads/images/24-08-2024/ab.webp" class="d-block w-100" alt="Image 1" loading="lazy">
          </div>
          <div class="carousel-item">
            <img src="public/uploads/images/24-08-2024/ab2.webp" class="d-block w-100" alt="Image 2" loading="lazy">
          </div>
          <div class="carousel-item">
            <img src="public/uploads/images/24-08-2024/ab3.webp" class="d-block w-100" alt="Image 3" loading="lazy">
          </div>
        </div>
    ...
    <div class="col-md-6">
      <div class="contentss">
        <img src="public/uploads/images/24-08-2024/icon-1.png" alt="Icon" class="iconss" loading="lazy">
        <!-- Hidden checkbox to toggle the content -->
        ...
        <!-- Label to act as a "Read more" button -->

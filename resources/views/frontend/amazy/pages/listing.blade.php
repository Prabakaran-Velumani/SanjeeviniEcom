...
@section('share_meta')
    ...
    <meta name="title" content="{{ $filter_name->name ?? $filter_name }} Products on {{ config('app.name') }}">
    <meta name="description" content="Browse our extensive collection of {{ $filter_name->name ?? $filter_name }} at {{ config('app.name') }}. Find a wide selection of {{ $filter_name->name ?? $filter_name }} in various styles and designs. Shop now for high-quality {{ $filter_name->name ?? $filter_name }} with fast shipping and great deals!">
    <meta property="og:title" content="{{ $filter_name->name ?? $filter_name }} Products on {{ config('app.name') }}" />
    <meta property="og:description" content="Browse our extensive collection of {{ $filter_name->name ?? $filter_name }} at {{ config('app.name') }}. Find a wide selection of {{ $filter_name->name ?? $filter_name }} in various styles and designs. Shop now for high-quality {{ $filter_name->name ?? $filter_name }} with fast shipping and great deals!" />
    <meta property="og:url" content="{{url()->current()}}" />
    @else
    <meta name="title" content="{{ $tag }} Products on {{ config('app.name') }}">
    <meta name="description" content="Browse our extensive collection of {{ $tag }} at {{ config('app.name') }}. Find a wide selection of {{ $tag }} in various styles and designs. Shop now for high-quality {{ $tag }} with fast shipping and great deals!">
    <meta property="og:title" content="{{ $tag }} Products on {{ config('app.name') }}" />
    <meta property="og:description" content="Browse our extensive collection of {{ $tag }} at {{ config('app.name') }}. Find a wide selection of {{ $tag }} in various styles and designs. Shop now for high-quality {{ $tag }} with fast shipping and great deals!" />
    <meta property="og:url" content="{{url()->current()}}" />
    @endif
@endsection

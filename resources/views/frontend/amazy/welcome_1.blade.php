...
<div class="container">
    <div class="row">
      <div class="custom-col col-sm-6 col-md-4 col-lg-3">
            <div class="image-box">
            <img src="public/frontend/amazy/img/wnecklace.webp" alt="wnecklace" width="387" height="306" >
                <div class="content">
                  <div class="discount">
  ...
  <button class="shop-buttons">Shop Now</button>
       ...
       <div class="custom-col col-sm-6 col-md-4 col-lg-3">
            <div class="image-box">
                <img src="public/frontend/amazy/img/imgg1.webp" alt="Gl"  width="387" height="306" >
                <div class="content">
                    <div class="discount">
                    <div class="discount-row">
 ...
 <div class="custom-col col-sm-6 col-md-4 col-lg-3">
            <div class="image-box">
                <img src="public/frontend/amazy/img/imgg2.webp" alt="Channapatna" width="387" height="306" >
                <div class="content">
                    <div class="discount">
                    <div class="discount-row">
...
<div class="custom-col col-sm-6 col-md-4 col-lg-3">
            <div class="image-box">
                <img src="public/frontend/amazy/img/imgg3.webp" alt="homemade" width="387" height="306"  >
                <div class="content">
                    <div class="discount">
                    <div class="discount-row">
  ...
  <button class="shop-buttons">Shop Now</button>
    ...
    <div class="custom-col col-sm-6 col-md-4 col-lg-3">
            <div class="image-box">
                <img src="public/frontend/amazy/img/imgg4.webp" alt="banana-fiber" width="387" height="306"  >
                <div class="content">
                    <div class="discount">
                    <div class="discount-row">
  ...
  <button class="shop-buttons">Shop Now</button>
    ...
    <div class="custom-col col-sm-6 col-md-4 col-lg-3">
            <div class="image-box">
                <img src="public/frontend/amazy/img/imgg5.webp" alt="Gift"  width="387" height="306" >
                <div class="content">
                    <div class="discount">
                    <div class="discount-row">
                        <strong class="big-discount">20%</strong>
  ...
  <button class="shop-buttons">Shop Now</button>
       ...
       <div class="custom-col col-sm-6 col-md-4 col-lg-3">
            <div class="image-box">
                <img src="public/frontend/amazy/img/imgg6.webp" alt="Tea" width="387" height="306"  >
                <div class="content">
                    <div class="discount">
                    <div class="discount-row">
                        <strong class="big-discount">10%</strong>
  ...
  <button class="shop-buttons">Shop Now</button>
      ...
      <div class="custom-col col-sm-6 col-md-4 col-lg-3">
            <div class="image-box">
                <img src="public/frontend/amazy/img/imgg7.webp" alt="Buddha" width="387" height="306" >
                <div class="content">
                    <div class="discount">
                    <div class="discount-row">
                        <strong class="big-discount">10%</strong>

...
<div class="footer-top" style="background-image: url('{{ $appUrl }}/public/uploads/all/66cec1a66c853.png'); ">
  <div class="container-fluid" >
    <div class="row">
      ...
      <center><img src="{{ $appUrl }}/public/frontend/amazy/img/free.png" alt="" class="lg" loading="lazy"></center>
	    <div class="fotop-txt">Free Delivery</div>
	  </div>
	  <div class="col-xl-2 col-lg-2 col-md-6 footer_links_50">
      <center><img src="{{ $appUrl }}/public/frontend/amazy/img/pro.png" alt=""class="lgs"loading="lazy"></center>
	    <div class="fotop-txt">100% Purchase Protection</div>
	  </div>
	  <div class="col-xl-2 col-lg-2 col-md-6 footer_links_50">
      <center><img src="{{ $appUrl }}/public/frontend/amazy/img/sec.png" alt="" class="lg" loading="lazy"></center>
	    <div class="fotop-txt">Secure Payment</div>
	  </div>
	  <div class="col-xl-2 col-lg-2 col-md-6 footer_links_50"> 
      <center><img src="{{ $appUrl }}/public/frontend/amazy/img/qual.png" alt="" class="lg" loading="lazy"></center>
	    <div class="fotop-txt">Assured Quality</div>
	  </div>
	  <div class="col-xl-2 col-lg-2 col-md-6 footer_links_50 footernone">
      <center><img src="{{ $appUrl }}/public/frontend/amazy/img/org.png" alt=""  class="lg" loading="lazy"></center>
...
<!-- FOOTER::START  -->
    <footer class="home_three_footer">
        ...
        <img src="{{url('/')}}/public/frontend/amazy/img/newlg.png" alt="Logo" class="img-fluid" loading="lazy"> 
 ...
 <img src="{{url('/')}}/public/frontend/amazy/img/amaz_icon/newttww.png" style="padding-bottom: 10px;" alt="social">
        ...
        <a href="" target="_blank" class="linkedin-icon"alt="social">
            <i class="fab fa-linkedin"></i>
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 footer_links_501 ">
...
<div class="col-lg-2 col-xl-2 col-md-6 footer_links_501">
    <div class="footer_widget">
        <h4><b>Get it on</b></h4>
        <div class="apps_box">
            @if($footer_content->show_play_store)
                <a href="{{ $footer_content->play_store }}" class="google_play_boxx d-flex align-items-center mb_10">
                    <div class="newimg">
                        <img 
                            src="{{ url('/') }}/public/frontend/amazy/img/amaz_icon/google-playss.jpg"
                            srcset="{{ url('/') }}/public/frontend/amazy/img/amaz_icon/google-playss.jpg 320w,
                                    {{ url('/') }}/public/frontend/amazy/img/amaz_icon/google-playss.jpg 640w,
                                    {{ url('/') }}/public/frontend/amazy/img/amaz_icon/google-playss.jpg 1024w"
                            sizes="(max-width: 600px) 320px,
                                   (max-width: 1200px) 640px,
                                   1024px"
                            width="100%" 
                            height="100%" 
                            alt="{{ __('amazy.Google Play') }}" 
                            title="{{ __('amazy.Google Play') }}"
                            loading="lazy">
                    </div>
                </a>
            @endif
            ...
            @if($footer_content->show_app_store)
                <a href="{{ $footer_content->app_store }}" class="google_play_boxx d-flex align-items-center">
                    <div class="newimg">
                        <img 
                            src="{{ url('/') }}/public/frontend/amazy/img/amaz_icon/appleplay.jpg"
                            alt="{{ __('amazy.Apple Store') }}" 
                            title="{{ __('amazy.Apple Store') }}"
                            loading="lazy">
                    </div>
                </a>
            @endif

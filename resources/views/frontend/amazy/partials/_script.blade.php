...
<script src="{{ asset(asset_path('frontend/amazy/compile_js/app2.js')) }}" ></script>
<script src="{{ asset(asset_path('frontend/amazy/compile_js/app4.js')) }}" ></script>
<script src="{{ asset(asset_path('frontend/amazy/compile_js/app6.js')) }}" ></script>
<script>

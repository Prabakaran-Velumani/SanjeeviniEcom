                            ...
                            <div class="white_box pt-0 box_shadow_white mb-20 p-15">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 cost_price_div">
                                        <div class="primary_input mb-15">
                                            <label class="primary_input_label" for=""> {{ __('product.seller_price') }}</label>
                                            <input class="primary_input_field cost_price" name="cost_price" id="cost_price" placeholder="{{ __('product.seller_price') }}" type="number" min="1" step="{{step_decimal()}}" value="{{old('cost_price')?old('cost_price'):''}}">
                                        </div>
                                    </div>

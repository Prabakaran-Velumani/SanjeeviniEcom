...
class OrderManageController extends Controller
{
    ...
    public function LabelPrint($id)
    {
        ...
        $data['customer'] = User::where('role_id','4')->where('id',$customer_id)->get();
        $data['setting'] = GeneralSetting::with(['city','state'])->first();
        return view('ordermanage::order_manage.sale_label_print', $data);
